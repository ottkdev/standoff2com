        ...
        <table className="w-full min-w-[600px]">
          <thead className="bg-muted/30 border-b border-border">
            <tr>
              ...
              <th className="text-center px-4 py-3 text-xs font-semibold text-muted-foreground hidden sm:table-cell w-24">Etiket</th>
              <th className="text-center px-4 py-3 text-xs font-semibold text-muted-foreground w-20">Cevap</th>
              <th className="text-center px-4 py-3 text-xs font-semibold text-muted-foreground hidden md:table-cell w-28">Görüntülenme</th>
            </tr>
          </thead>
          <tbody>
            {posts.map((post) => (
              ...
              >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 text-xs text-muted-foreground mt-1">
                        ...
                        <span className="hidden sm:inline truncate">{post.category.name}</span>
                        <span>•</span>
                ...
                <td className="px-4 py-3 text-center text-sm text-muted-foreground hidden md:table-cell whitespace-nowrap">
